...
const Footer = ({menu}) => {
  ...
  return (
    <footer className="bg-black grid items-center	 gap-4 md:gap-8  grid-cols-1 md:grid-cols-2 grid-rows-3 md:grid-rows-2 py:12 md:py-20 px-6 md:px-12 lg:px-16">
