...
const HomeLargeWithMethodology = ({how_we_work}) => {
  ...
  return (
    ...
    <section className="home-hero-large grid grid-cols-1 pt-32 pb-32 md:pb-60 px-6 md:px-12 lg:px-16 overflow-x-hidden">
        <h1 className="text-3xl md:text-5xl lg:text-7xl font-semibold uppercase relative text-center md:text-start">Aumentá las <span className="underline-custom">ventas</span> de tu negocio <br className="hidden lg:block"/>a travéz de <span className="underline-custom">canales digitales</span></h1>
