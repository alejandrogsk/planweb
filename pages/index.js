...
">
    ...
    ">
        ...
        <div className="flex flex-col md:flex-row">
            <Link href={heroContent.cta1.url}>
                <a className="transition-all duration-200 shadow text-lg md:text-xl inline-block px-6 py-3 bg-primary text-black hover:bg-white hover:md:bg-white uppercase text-center">
                    {heroContent.cta1.title}
                </a>
            </Link>
            <Link href={heroContent.cta2.url}>
